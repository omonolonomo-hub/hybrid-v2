...
@pytest.mark.xfail(reason="H3-7: HandPanel info_rect layout overflow — UI sabitlenmeli", strict=False)
...
@pytest.mark.xfail(reason="H3-7: LobbyPanel.capacity_rect eksik — UI sabitlenmeli", strict=False)
