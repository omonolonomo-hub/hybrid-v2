...
class MenuScene(Scene):
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        for y in range(Screen.H):
            ...
            pygame.draw.line(surface, (r, g, b), (0, y), (Screen.W, y))
        ...
        for i, color in enumerate(category_colors):
            ...
            pygame.draw.rect(surface, color, (x_start, stripe_y, x_end - x_start, stripe_height))
        ...
        for i in range(3):
            ...
            pygame.draw.rect(glow_surf, (*Colors.MIND, glow_alpha), 
        ...
        # İnce border (ShopScene tarzı)
        pygame.draw.rect(surface, Colors.MIND, self._btn_rect, width=2, border_radius=8)
    ...
    def handle_event(self, event: pygame.event.Event) -> None:
        ...
        """
        # Sadece sol fare butonu tıklamalarını işle (Gereksinim 11.4)
