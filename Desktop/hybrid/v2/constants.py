...
class Layout:
    ...
    SHOP_BTN_W: int      = 140
    SHOP_BTN_H: int      = 42
    SHOP_BTN_X: int      = SHOP_INFO_X - SHOP_BTN_W - 15
    REROLL_BTN_X: int    = SHOP_BTN_X
    REROLL_BTN_Y: int    = SHOP_PANEL_Y + 27
    REROLL_BTN_W: int    = SHOP_BTN_W
    REROLL_BTN_H: int    = SHOP_BTN_H
    LOCK_BTN_H: int      = SHOP_BTN_H
    LOCK_BTN_Y: int      = REROLL_BTN_Y + SHOP_BTN_H + 15
    READY_BTN_Y: int     = LOCK_BTN_Y + SHOP_BTN_H + 15
...
class Colors:
    ...
    # Passive effects colors
    PASSIVE_EFFECTS: dict[str, tuple[int, int, int]] = {
        "copy_2": (255, 200, 55),
        "copy_3": (255, 160, 20),
...
class Paths:
    ...
    # Passive effect icons
    PASSIVE_ICONS: dict[str, str] = {
        "copy_2": "STAR",
        "copy_3": "STAR",
